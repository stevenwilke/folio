        ...
        <div style={s.body}>
          {step === 'upload' && (
            <>
              ...
              <div style={s.uploadArea} onClick={() => fileRef.current?.click()}>
                ...
                <div style={{ fontWeight: 600, color: '#1a1208', fontSize: 14 }}>Click to select your Goodreads CSV</div>
                <div style={{ fontSize: 12, color: '#8a7f72', marginTop: 4 }}>goodreads_library_export.csv</div>
              </div>
          ...
          {step === 'preview' && (
            <>
              ...
              <div style={s.previewList}>
                ...
                {books.length > 8 && (
                  <div style={{ padding: '8px 0', fontSize: 12, color: '#8a7f72', textAlign: 'center' }}>
          ...
          {step === 'importing' && (
            <div style={{ textAlign: 'center', padding: '32px 0' }}>
              ...
              <div style={{ fontWeight: 600, color: '#1a1208', marginBottom: 4 }}>
                Importing {progress.done} of {progress.total}…
              </div>
              <div style={s.importProgressBg}>
                <div style={{ ...s.importProgressFill, width: `${pct}%` }} />
              </div>
              <div style={{ fontSize: 12, color: '#8a7f72', marginTop: 8 }}>{pct}% complete</div>
            </div>
          )}
...
const s = {
  ...
  modal:            { background: '#fdfaf4', border: '1px solid #d4c9b0', borderRadius: 16, width: 520, maxWidth: '92vw', maxHeight: '85vh', display: 'flex', flexDirection: 'column', boxShadow: '0 24px 64px rgba(26,18,8,0.2)' },
  ...
  step:             { display: 'flex', alignItems: 'center', gap: 10, fontSize: 14, color: '#3a3028' },
  stepNum:          { width: 24, height: 24, borderRadius: '50%', background: '#c0521e', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, flexShrink: 0 },
  uploadArea:       { border: '2px dashed #d4c9b0', borderRadius: 12, padding: '32px 24px', textAlign: 'center', cursor: 'pointer', background: '#fdfaf4', transition: 'border-color 0.15s' },
  errorMsg:         { fontSize: 13, color: '#c0521e', marginTop: 12 },
  previewHeader:    { fontSize: 14, color: '#3a3028', marginBottom: 16 },
  previewList:      { border: '1px solid #e8dfc8', borderRadius: 8, overflow: 'hidden', marginBottom: 20 },
  previewRow:       { display: 'flex', alignItems: 'center', gap: 12, padding: '10px 14px', borderBottom: '1px solid #f0e8d8' },
  previewTitle:     { fontSize: 13, fontWeight: 500, color: '#1a1208', lineHeight: 1.3 },
  previewAuthor:    { fontSize: 11, color: '#8a7f72', marginTop: 2 },
  ...
  importProgressBg: { width: '100%', height: 8, background: '#e8dfc8', borderRadius: 4, overflow: 'hidden', margin: '12px 0' },
  importProgressFill:{ height: '100%', background: '#c0521e', borderRadius: 4, transition: 'width 0.3s' },
}
