...
const s = {
  ...
  tabActive:     { padding: '10px 20px', background: 'none', border: 'none', borderBottom: '2px solid #c0521e', marginBottom: -1, fontSize: 14, fontWeight: 600, color: '#c0521e', cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" },
  ...
  listingCard:   { background: '#fdfaf4', border: '1px solid #d4c9b0', borderRadius: 12, overflow: 'hidden' },
